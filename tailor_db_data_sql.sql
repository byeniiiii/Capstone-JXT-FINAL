...
--
-- Host: 127.0.0.1
-- Generation Time: May 27, 2025 at 03:00 PM
...
--
-- Table structure for table `made_to_order`
--

CREATE TABLE `made_to_order` (
  `mto_id` int(11) NOT NULL,
  `order_id` varchar(10) NOT NULL,
  `category` enum('band_uniform','school_uniform','security_uniform','other') NOT NULL,
  `description` text NOT NULL,
  `fabric_source` enum('customer','shop') NOT NULL DEFAULT 'shop',
  `quantity` int(11) NOT NULL DEFAULT 1,
  `reference_image` varchar(255) DEFAULT NULL,
  `special_instructions` text DEFAULT NULL,
...
(15, 'XZAJB', 18, 'Order moved to production.', '2025-05-27 14:28:08');
...
(68, 'Payment Confirmed', 2093, 'XZAJB', 'Your payment of ₱0.00 for Order #XZAJB has been confirmed.', 1, '2025-05-27 05:45:39'),
(69, 'Order In Process', 2093, 'XZAJB', 'Your Tailoring order #XZAJB is now being processed.', 1, '2025-05-27 06:28:08');
...
('XZAJB', 2093, 'tailoring', '0.00', '0.00', 'cash', 'downpayment_paid', 'in_process', 18, NULL, NULL, '2025-05-19 21:27:27', '2025-05-27 06:28:08', NULL, NULL),
...
CREATE TABLE `order_status_history` (
  ...
  `order_id` varchar(10) NOT NULL,
  `status` enum('pending_approval','declined','approved','forward_to_sublimator','in_process','printing_done','ready_for_pickup','completed') NOT NULL,
  ...
  CONSTRAINT `order_status_history_ibfk_2` FOREIGN KEY (`updated_by`) REFERENCES `users` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(6, 'XZAJB', 'in_process', 18, 'Order moved to production.', '2025-05-27 06:28:08');
...
--
-- Indexes for table `made_to_order`
--
ALTER TABLE `made_to_order`
  ADD PRIMARY KEY (`mto_id`),
  ADD KEY `mto_order_fk` (`order_id`);
...
--
-- AUTO_INCREMENT for table `made_to_order`
--
ALTER TABLE `made_to_order`
...
--
-- Constraints for table `made_to_order`
--
ALTER TABLE `made_to_order`
  ADD CONSTRAINT `mto_order_fk` FOREIGN KEY (`order_id`) REFERENCES `orders` (`order_id`) ON DELETE CASCADE ON UPDATE CASCADE;
