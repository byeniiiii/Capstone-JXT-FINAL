...
<head>
    ...
    <style>
        ...
        .swal2-html-container {
            ...
            overflow: hidden !important; /* Prevent any scrollbars in the content */
        }
        .swal2-confirm {
        ...
        .swal2-container, .swal2-content, .swal2-popup {
            overflow-y: hidden !important;
            overflow-x: hidden !important;
        }
        /* Ensure paragraphs don't cause scrollbars */
        p {
            margin: 0.5em 0;
            padding: 0;
        }
        ...
        function showLogoutConfirmation() {
            Swal.fire({
                ...
                html: '<div class="logout-icon"><i class="fas fa-sign-out-alt"></i></div>' + 
                      ...
                      '<p class="small text-muted" style="margin-top: 8px; margin-bottom: 0;">You will be redirected to the login page.</p>',
                ...
                didOpen: () => {
                    ...
                    // Ensure no scrollbars in SweetAlert container
