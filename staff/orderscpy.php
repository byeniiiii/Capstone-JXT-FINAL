                    ...
                    $.ajax({
                        ...
                        error: function(xhr, status, error) {
                            Swal.fire({
                                icon: 'error',
                                title: 'Error',
                                text: 'There was an error approving the order.',
        ...
        function declineOrder() {
            ...
            if (!reason.trim()) {
                Swal.fire({
                    ...
                    text: 'Please provide a reason for declining the order.',
                    confirmButtonColor: '#d33'
                });
                return;
            }
            ...
            $.ajax({
                ...
                success: function(response) {
                    Swal.fire({
                        icon: 'success',
                        title: 'Declined!',
                        text: 'Order has been declined successfully.',
                        confirmButtonColor: '#d33'
                    }).then(() => {
                        var declineModal = bootstrap.Modal.getInstance(document.getElementById('declineModal'));
