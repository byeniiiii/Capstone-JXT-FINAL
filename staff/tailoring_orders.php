...
$records_per_page = 10;
$offset = ($page - 1) * $records_per_page; // <-- Missing semicolon here

// Build the query with filters
$where_clauses = ["o.order_type = 'tailoring'"]; // Add this filter for tailoring orders
$params = [];
$types = "";
...
$count_query = "SELECT order_status, COUNT(*) as count FROM orders WHERE order_type = 'tailoring' GROUP BY order_status";
...
<td>
    ...
    <!-- Mark In Process Icon - Only for approved orders -->
    <a href="javascript:void(0)" 
       class="btn btn-sm btn-outline-primary" 
       onclick="markInProcess('<?php echo $order['order_id']; ?>')"
       data-bs-toggle="tooltip" title="Mark In Process">
